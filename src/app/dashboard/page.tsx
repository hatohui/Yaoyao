    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="bg-white border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <h1 className="text-2xl sm:text-3xl font-bold text-darkest">
            ...
            <div className="sm:w-64">
              <div className="relative">
                ...
                <select
                  ...
                  className="w-full pl-10 pr-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-main focus:border-main appearance-none bg-white"
                >
                  <option value="">
